                ...
                <div class="dropdown d-inline-block show">
                  ...
                  <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                    ...
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a href="{{ route('moviecat_status',['id'=>$movie->id,'status'=>1]) }}"
                          class="nav-link">Active
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('moviecat_status',['id'=>$movie->id,'status'=>0]) }}"
                    ...
                    <ul class="nav flex-column">
                      ...
                      <li class="nav-item">
                        <a href="javascript:void(0);" class="nav-link" type="button" onclick="delete_service(this);"
                          data-id="{{ route('upload-movies-category.destroy',$movie->id) }}">
