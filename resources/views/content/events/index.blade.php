...
<div class="card">
    ...
    <x-modal id="editModal{{ $event->id }}" title="Edit Event" size="xl" :show="old('showEditFormModal'.$event->id)? true: false" :showSaveBtn="false" :showFooter="false" :titleCentered="true" titleTag="h3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body list">
                        <div class="form-check mt-3">
                            <input name="status" class="form-check-input checkbox" type="radio" value="0" id="pending" {{ (int) $event->status === 0? 'checked': '' }}>
                            <label class="form-check-label" for="pending">
                                Pending
                            </label>
                        </div>
                        <div class="form-check mt-3">
                            <input name="status" class="form-check-input checkbox" type="radio" value="1" id="approved" {{ (int) $event->status === 1? 'checked': '' }}>
                            <label class="form-check-label" for="approved">
                                Approved
                            </label>
                        </div>
                        <div class="form-check mt-3">
                            <input name="status" class="form-check-input checkbox rejected" type="radio" value="2" id="rejected" {{ (int) $event->status === 2? 'checked': '' }}>
...
<x-modal id="createModal" title="Add Event" size="xl" :show="old('showCreateFormModal')? true: false" :showSaveBtn="false" :showFooter="false" :titleCentered="true" titleTag="h3">
...
<script>
    ...
    element.innerHTML = `<label class="form-check-label" for="rejected">Reason</label>
                     <textarea name="reason" class="form-control rejected" type="radio" value="2" id="rejected">{{ $event->reason ?? '' }}</textarea>`;
    checkboxes.forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
            if (checkbox.checked && checkbox.value == 2) {
                checkbox.parentNode.parentNode.append(element);
            } else {
