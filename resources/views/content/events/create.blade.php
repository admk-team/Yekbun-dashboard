...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Events /</span> Add Events
</h4>
<div class="row">
    <div class="col-12">
      <div class="card">
        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 86.9375px;"><div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="">
          <h5 class="card-title mb-sm-0 me-2">Events</h5>
          <div class="action-btns">
            <a href="{{ route('app-event') }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <label class="form-label" for="fullname">Event Title</label>
