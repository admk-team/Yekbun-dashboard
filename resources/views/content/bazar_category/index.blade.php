...
<div class="d-flex justify-content-center mt-2 mb-2">
    <button class="btn btn-primary col-md-3 mr-2" data-bs-toggle="modal" data-bs-target="#createbazarcategoryModal">Add Category</button>
    <button class="btn btn-primary col-md-3" data-bs-toggle="modal" data-bs-target="#createbazarsubcategoryModal">Add SubCategory</button>
</div>
                        ...
                        <div class="dropdown d-inline-block show">
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -362px, 0px); top: 0px; left: 0px; will-change: transform;min-width: 9rem;">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('bazarcat-status',['id'=>$bazar->id,'status'=>1]) }}" class="nav-link">Active
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('bazarcat-status',['id'=>$bazar->id,'status'=>0]) }}" class="nav-link">Deactive</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu" style="min-width: 9rem;">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="javascript:void(0);" class="nav-link" type="button" onclick="delete_service(this);" data-id="{{ route('bazar-category.destroy',$bazar->id) }}">
                        ...
                        <div class="modal fade" id="editbazarcategoryModal{{ $bazar->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <form method="POST" action="{{ route('bazar-category.update',$bazar->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
