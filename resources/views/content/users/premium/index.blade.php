...
<div class="row g-4 mb-4">
  ...
  <div class="card">
    <h5 class="card-header">Premium Users List</h5>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <!-- <a class="dropdown-item" href="{{ route('users.premium.edit', $user->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a> -->
                  ...
                  <form action="{{ route('users.premium.destroy', $user->id) }}" method="post">
                    @method('DELETE')
                    @csrf
