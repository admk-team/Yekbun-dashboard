...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">History Category /</span> All History Category
</h4>
</div>
<div class="">
                ...
                <div class="dropdown d-inline-block show">
                  ...
                  <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                    ...
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a href="{{ route('historycat-status',['id'=>$history->id,'status'=>1]) }}"
                          class="nav-link">Active
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{ route('historycat-status',['id'=>$history->id,'status'=>0]) }}"
            ...
            <td>
                <div class="dropdown d-inline-block">
                  ...
                  <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu" style="min-width: 9rem;">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a href="{{ route('history-category.edit',$history->id) }}" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="javascript:void(0);" class="nav-link" type="button" onclick="delete_service(this);"
                          data-id="{{ route('history-category.destroy',$history->id) }}">
