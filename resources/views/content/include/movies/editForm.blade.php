...
<script type="text/javascript">
  function custom_template(obj){
            ...
            if(data && data['img_src']){
                ...
                template = $("<div style=\"display:flex;align-items:center;gap:4px;\"><img src=\"" + img_src + "\" style=\"width:20px;height:20px;border-radius:20px;\"/><p style=\"font-weight: 400;font-size:10pt; \">" + text + "</p></div>");
                return template;
            }
        }
    var options = {
